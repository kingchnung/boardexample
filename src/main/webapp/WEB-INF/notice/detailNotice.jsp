...
<body>
	<div class="container">
		<div class="text-center"><h3>공지 상세 화면</h3></div>	
	<div class="row text-center mb-2">
		...
		<form name="dataForm" id="dataForm">
			<input type="hidden" name="num" value="${detail.noticeNo}">
		</form>
			...
			<table class="table table-bordered">
				<tbody>
					<tr>
						...
						<td class="col-md-3 text-start">${detail.noticeNo}<label>(조회수:
								${detail.viewCnt})</label>
						</td>
					...
					<tr>
						...
						<td colspan="3" class="col-md-9 text-start">${detail.writer}</td>
					</tr>
					<tr>
	...
	<script src="/include/js/detailNotice.js"></script>
</body>
</html>